...
class USEUP_ME_Ajax_Shop_Filter {
	...
	private function get_icon_map() {
		return array(
			...
			'foto' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><g transform="rotate(10 15.5 10.5)"><rect x="10.2" y="4" width="8.2" height="12.8" rx="0.8"></rect><path d="M10.2 13.6h8.2"></path></g><rect x="5.2" y="6.8" width="10.2" height="12.8" rx="0.8"></rect><path d="M5.2 16h10.2"></path></svg>',			
